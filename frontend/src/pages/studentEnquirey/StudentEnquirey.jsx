...
function StudentEnquirey() {
    ...
    const handleDelete = async (applicationId) => {
        try {
            const response = await fetch(`${API_BASE_URL}/deleteStudent-enquiry/${applicationId}`, {
                method: 'DELETE',
            });
            ...
            cell: row => (
                <>
                    <button
                        ...
                        onClick={() => navigate(`/view-student-enquirey/${row._id}`)}
                    >
...
export default StudentEnquirey