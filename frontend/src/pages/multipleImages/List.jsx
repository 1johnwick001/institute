...
function ListMultipleImages() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/multiple-images`);
    ...
    const handleDeleteConfirmation = async () => {
        try {
        await axios.delete(`${API_BASE_URL}/delete-multiple-images/${factsIdToDelete}`);
    ...
    const columns = [
        ...
        
        {
            ...
            selector: row => row.images && row.images.length > 0 
                ? <img src={`${API_BASE_IMAGE_URL}/${row.images[0]}`} alt="multiple" style={{ width: '55px', height: '55px' }} /> 
                : 'No image',
        ...
        },
        {
            ...
            cell: (row) => (
                <>
                    <button className="btn btn-warning btn-sm m-2" onClick={() => navigate(`/editMultipleImages/${row._id}`)}>
            ...
            <Pagetitle page='Multiple Images' />
                <section className='section'>
                    <div className="d-flex justify-content-end mb-3">
                        ...
                        onClick={()=>navigate('/createMultipleImages')}
                        >Add Multiple Images
                        </button>
                    </div>
                    <DataTable
...
export default ListMultipleImages